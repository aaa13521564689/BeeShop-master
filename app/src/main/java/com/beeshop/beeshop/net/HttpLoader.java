...
//    }
     ...
     * @param subscriber
     */
    public void modifyPrice(final HashMap<String, Object> params, CompositeSubscription compositeSubscription, SubscriberCallBack subscriber) {
        normalPost(mApiManager.postModifyPrice(createRequest(params)),compositeSubscription,new Func1<String, ResponseEntity>() {//将接口返回的String数据，转换为实体类
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity>() {}.getType());
     ...
     * @param subscriber
     */
    public void setOrderState(final HashMap<String, Object> params, CompositeSubscription compositeSubscription, SubscriberCallBack subscriber) {
        normalPost(mApiManager.postSetOrderState(createRequest(params)),compositeSubscription,new Func1<String, ResponseEntity>() {//将接口返回的String数据，转换为实体类
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity>() {}.getType());
...
//看购物车
    public void showcarshopping(final HashMap<String, Object> params,CompositeSubscription compositeSubscription,SubscriberCallBack<List<GoodBean1.Data>>  subscriber){
        normalPost(mApiManager.postchakaguwuche(createRequest(params)),compositeSubscription, new Func1<String, ResponseEntity>() {
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity<List<GoodBean1.Data>> response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity<List<GoodBean1.Data>>>() {}.getType());
                LoggerUtil.i(JsonUtil.formatNetLog(GsonUtil.gsonMapToString(params),GsonUtil.gsonString(response)));
    ...
    public void addshopping(final HashMap<String, Object> params,CompositeSubscription compositeSubscription,SubscriberCallBack subscriber) {
        normalPost(mApiManager.postaddshopcar(createRequest(params)),compositeSubscription,new Func1<String, ResponseEntity>() {//将接口返回的String数据，转换为实体类
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity>() {}.getType());
    ...
    //购物车增减
    public void shopcarproshopping(final HashMap<String, Object> params,CompositeSubscription compositeSubscription,SubscriberCallBack subscriber) {
        normalPost(mApiManager.shopcarpro(createRequest(params)),compositeSubscription,new Func1<String, ResponseEntity>() {//将接口返回的String数据，转换为实体类
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity>() {}.getType());
    ...
    //购物车删除
    public void deleteshopping(final HashMap<String, Object> params,CompositeSubscription compositeSubscription,SubscriberCallBack subscriber) {
        normalPost(mApiManager.deletecarpro(createRequest(params)),compositeSubscription,new Func1<String, ResponseEntity>() {//将接口返回的String数据，转换为实体类
            @Override
            public ResponseEntity call(String s) {
                String responseStr = RSAUtil.decryptByPublicKey(Base64.decode(s,Base64.DEFAULT));
                ResponseEntity response = GsonUtil.gsonToResponse(responseStr,new TypeToken<ResponseEntity>() {}.getType());
