...
public interface ApiManager {
    ...
    Observable<String> postchakaguwuche(@FieldMap HashMap<String, Object> map);
    //加入购物车
    @FormUrlEncoded
    @POST("/trade/addshopcar")
    Observable<String> postaddshopcar(@FieldMap HashMap<String,Object>map);
    //购物车增减
    @FormUrlEncoded
    @POST("/trade/shopcarpro_update")
    Observable<String> shopcarpro(@FieldMap HashMap<String,Object>map);
    //购物车删除
    @FormUrlEncoded
    @POST("/trade/deleteshopcar")
    Observable<String> deletecarpro(@FieldMap HashMap<String,Object>map);
}
