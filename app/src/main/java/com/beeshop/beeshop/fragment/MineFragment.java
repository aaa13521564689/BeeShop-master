...
public class MineFragment extends BaseFragment {
    ...
    @BindView(R.id.rl_set_addguwu)
    RelativeLayout rl_set_addguwu;
        ...
        confirmDialog = new MaterialDialog(getActivity())
                ...
                .setPositiveButton("确认", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PrefUtils.setString(getActivity().getApplicationContext(),"fengdian","2");
                        Intent intent = new Intent(getActivity(), No_wanActivity.class);
    ...
    @OnClick({R.id.rl_mine_data, R.id.rl_my_vip,R.id.rl_set_addguwu, R.id.rl_quit,R.id.rl_my_order, R.id.rl_set_address, R.id.rl_my_broadcast, R.id.rl_my_tool, R.id.rl_update})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.rl_update:
                Beta.checkUpgrade();
                break;
            case R.id.rl_set_addguwu:
                startActivity(new Intent(getActivity(), Myaddshopping.class));
                break;
        }
    }
