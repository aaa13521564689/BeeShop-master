...
public class ProductDetailActivity extends BaseActivity {
    ...
    private int mProductId,shop_id,product_id,num;
...
//                startActivity(intent1);
    ...
    private void addguwuche() {
        HashMap<String, Object> params = new HashMap<>();
        LoggerUtil.d("token----"+SharedPreferenceUtil.getUserPreferences(SharedPreferenceUtil.KEY_TOKEN, ""));
        LoggerUtil.d("shop_id----"+shop_id);
        LoggerUtil.d("product_id----"+product_id);
//        LoggerUtil.d("num----"+num);
        ...
        HttpLoader.getInstance().addshopping(params, mCompositeSubscription, new SubscriberCallBack() {
    ...
    private void getProductInfo() {
        ...
        HttpLoader.getInstance().getProductInfo(params1, mCompositeSubscription, new SubscriberCallBack<ProductDetailEntity>(this,this) {
            ...
            protected void onSuccess(ProductDetailEntity response) {
                ...
                product_id=Integer.parseInt(response.getId());
                //num=Integer.parseInt(response.getNum());
                shop_id=Integer.parseInt(response.getShop_id());
